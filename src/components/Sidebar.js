                ...
                <div className="sidebar">
                    ...
                    <div className="navigation-wrapper" style={{display: `${navVisibility}`}} >
                        ...
                        <div className="link-wrapper">
                            <Link to="/organization" className="link" onClick={mediaQuery.matches ? '' : toggleNavVisibility}>
                        ...
                        <div className="link-wrapper">
                            <Link to="/location" className="link" onClick={mediaQuery.matches ? '' : toggleNavVisibility}>
                                <svg viewBox="0 0 24 24" width="16" height="16" className="inline-block">
                        ...
                        <div className="link-wrapper">
                            <Link to="/workplace" className="link" onClick={mediaQuery.matches ? '' : toggleNavVisibility}>
                                <svg viewBox="0 0 24 24" width="16" height="16" className="inline-block">
                        ...
                        <div className="link-wrapper">
                            <Link to="/contractors" className="link" onClick={mediaQuery.matches ? '' : toggleNavVisibility}>
                                <svg viewBox="0 0 24 24" width="16" height="16" className="inline-block">
                        ...
                        <div className="link-wrapper">
                            <Link to="/workers" className="link" onClick={mediaQuery.matches ? '' : toggleNavVisibility}>
                                <svg viewBox="0 0 24 24" width="16" height="16" className="inline-block">
                        ...
                        <div className="link-wrapper">
                            <Link to="/users" className="link" style={{paddingBottom: '12px'}} onClick={mediaQuery.matches ? '' : toggleNavVisibility}>
                                <svg viewBox="0 0 24 24" width="16" height="16" className="inline-block">
