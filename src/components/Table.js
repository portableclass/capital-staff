...
export default function Table({ columns, data,
    ...
    return (
        <>
                        ...
                        <div className="page-switch">
                            ...
                            {/* {console.log(Array.from({ length: columns.length },   () => columns.map(item => item.accessor )     ))} */}
                            {
                                Array.from({ length: pagesCount >= 1 ? pagesCount : 1 }, (_, index) => index + 1)
                                    .map(page => {
                                        if (page === currentPage) {
                                            return <a href={"#page" + page} onClick={() => setPage(page)} style={{ border: "3px solid black" }}>
                                                <span>
                                                    {page}
                                                </span>
                                            </a>
                                            ...
                                            return <a href={"#" + page} onClick={() => setPage(page)}>
                                                <span>
                                                    {page}
                                                </span>
                                            </a>
            ...
            {(tableMode === mode.update || tableMode === mode.create) &&
                <UpdateTable
                    columns={columns}
