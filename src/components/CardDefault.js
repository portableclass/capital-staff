import '../assets/styles/scss/cardDefault.scss';
        ...
        <>
            <div className="card-wrapper">
                <div className="description-wrapper">
                    ...
                    <p className="card-number">{curNum + '/' + stockNum}</p>
                    {/* <p className="card-number">{curNum}</p>
                    <p className="card-number">/</p>
                    <p className="card-number">{ stockNum }</p> */}
                </div>
                <div className="card-ico">
                    <svg viewBox="0 0 24 24" className="inline-block">
                        <path fill={fillColor} d={ pathSvg } />
                    </svg>
                </div>
            </div>
        </>
